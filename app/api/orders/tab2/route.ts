...
export async function GET(request: NextRequest) {
  try {
    ...
    return NextResponse.json(data as OrderTab2[]);
  } catch (error) {
    console.error('GET /api/orders/tab2 error:', error);
    return NextResponse.json({ error: 'Failed to fetch orders' }, { status: 500 });
  }
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('POST /api/orders/tab2 error:', error);
    return NextResponse.json({ error: 'Failed to create order' }, { status: 500 });
  }
}
...
export async function PUT(request: NextRequest) {
  try {
    ...
    console.error('PUT /api/orders/tab2 error:', error);
    return NextResponse.json({ error: 'Failed to update order' }, { status: 500 });
  }
}
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    console.error('DELETE /api/orders/tab2 error:', error);
    return NextResponse.json({ error: 'Failed to delete order' }, { status: 500 });
  }
}
